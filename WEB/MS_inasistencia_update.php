...
try {
  ...
  $sql = "UPDATE mobility_solutions.tmx_inasistencia SET ".implode(", ", $setParts)." WHERE id = ?";
  ...
  if ($stmt->execute()) {
    ...
    echo json_encode(["success" => false, "message" => "Error al actualizar inasistencia: ".$stmt->error]);
  }
