...
foreach ($meses as $mes) {
    $valores[$mes] = is_numeric($data[$mes]) ? $data[$mes] : 0;
}
...
if ($result->num_rows > 0) {
    ...
    $insert_sql = "
        INSERT INTO mobility_solutions.tmx_metas (
            tipo_meta, asignado, anio, enero, febrero, marzo, abril, mayo, junio, julio, agosto, septiembre, octubre, noviembre, diciembre,
