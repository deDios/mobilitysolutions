...
<body>
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <form action="db_consultas/insert_sp_mod.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3 col-6 mt-5">
                        <input id="InputMod" type="text" class="form-control" name="InputMod" aria-label="Default select example" required>
                        </div>
                        <div class="invalid-feedback">
                            Porfavor llenar campo de Modelo
                    </div>
